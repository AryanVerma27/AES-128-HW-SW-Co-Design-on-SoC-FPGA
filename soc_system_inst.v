	soc_system u0 (
		...
		.pio_ciphertext0_external_connection_export (<connected-to-pio_ciphertext0_external_connection_export>), // pio_ciphertext0_external_connection.export
		.pio_ciphertext1_external_connection_export (<connected-to-pio_ciphertext1_external_connection_export>), // pio_ciphertext1_external_connection.export
		.pio_ciphertext2_external_connection_export (<connected-to-pio_ciphertext2_external_connection_export>), // pio_ciphertext2_external_connection.export
		.pio_ciphertext3_external_connection_export (<connected-to-pio_ciphertext3_external_connection_export>), // pio_ciphertext3_external_connection.export
		.pio_key0_external_connection_export        (<connected-to-pio_key0_external_connection_export>),        //        pio_key0_external_connection.export
		.pio_key10_external_connection_export       (<connected-to-pio_key10_external_connection_export>),       //       pio_key10_external_connection.export
		.pio_key11_external_connection_export       (<connected-to-pio_key11_external_connection_export>),       //       pio_key11_external_connection.export
		.pio_key12_external_connection_export       (<connected-to-pio_key12_external_connection_export>),       //       pio_key12_external_connection.export
		.pio_key14_external_connection_export       (<connected-to-pio_key14_external_connection_export>),       //       pio_key14_external_connection.export
		.pio_key15_external_connection_export       (<connected-to-pio_key15_external_connection_export>),       //       pio_key15_external_connection.export
		.pio_key1_external_connection_export        (<connected-to-pio_key1_external_connection_export>),        //        pio_key1_external_connection.export
		.pio_key2_external_connection_export        (<connected-to-pio_key2_external_connection_export>),        //        pio_key2_external_connection.export
		.pio_key3_external_connection_export        (<connected-to-pio_key3_external_connection_export>),        //        pio_key3_external_connection.export
		.pio_key4_external_connection_export        (<connected-to-pio_key4_external_connection_export>),        //        pio_key4_external_connection.export
		.pio_key5_external_connection_export        (<connected-to-pio_key5_external_connection_export>),        //        pio_key5_external_connection.export
		.pio_key6_external_connection_export        (<connected-to-pio_key6_external_connection_export>),        //        pio_key6_external_connection.export
		.pio_key7_external_connection_export        (<connected-to-pio_key7_external_connection_export>),        //        pio_key7_external_connection.export
		.pio_key8_external_connection_export        (<connected-to-pio_key8_external_connection_export>),        //        pio_key8_external_connection.export
		.pio_key9_external_connection_export        (<connected-to-pio_key9_external_connection_export>),        //        pio_key9_external_connection.export
		.pio_plaintext0_external_connection_export  (<connected-to-pio_plaintext0_external_connection_export>),  //  pio_plaintext0_external_connection.export
		.pio_plaintext1_external_connection_export  (<connected-to-pio_plaintext1_external_connection_export>),  //  pio_plaintext1_external_connection.export
		.pio_plaintext2_external_connection_export  (<connected-to-pio_plaintext2_external_connection_export>),  //  pio_plaintext2_external_connection.export
		.pio_plaintext3_external_connection_export  (<connected-to-pio_plaintext3_external_connection_export>),  //  pio_plaintext3_external_connection.export
		.reset_reset_n                              (<connected-to-reset_reset_n>),                              //                               reset.reset_n
		.pio_enable_0_external_connection_export    (<connected-to-pio_enable_0_external_connection_export>),    //    pio_enable_0_external_connection.export
		.pio_reset0_external_connection_export      (<connected-to-pio_reset0_external_connection_export>),      //      pio_reset0_external_connection.export
		.pio_key13_external_connection_export       (<connected-to-pio_key13_external_connection_export>)        //       pio_key13_external_connection.export
	);
